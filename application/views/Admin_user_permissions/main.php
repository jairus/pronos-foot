				...
				<div class="form-group fg-line">
					...
					if(isset($filters)&&is_array($filters)){
						...
						<select class="selectpicker" multiple name="filters[]">
							<option value="user_group" <?php if(in_array("user_group", $filters)){ echo "selected"; } ?>>Permission</option>	<option value="class_name" <?php if(in_array("class_name", $filters)){ echo "selected"; } ?>>Controller Class Name</option>	<option value="function" <?php if(in_array("function", $filters)){ echo "selected"; } ?>>Function</option>	
						</select>
						<?php
					}
					else{
						?>
						<select class="selectpicker" multiple name="filters[]">
							<option value="user_group">Permission</option>	<option value="class_name">Controller Class Name</option>	<option value="function">Function</option>	
						</select>
						<?php
					}
					?>
	...
	<div class="table-responsive">
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					<th>#</th>
					<th class="sortby" data-sortby="user_group" >Permission <?php
	if($sortby=="user_group"){
		if($sort=="asc"){
...
?></th><th class="sortby" data-sortby="class_name" >Controller Class Name <?php
...
?></th><th class="sortby" data-sortby="function" >Function <?php
	if($sortby=="function"){
		if($sort=="asc"){
			echo '&nbsp;<i class="zmdi zmdi-caret-up"></i>';
		}
				...
				if($t){
					for($i=0; $i<$t; $i++){
						...
						?>
							...
							<td><?php echo $records[$i]['user_group'];?></td><td><?php echo $records[$i]['class_name'];?></td><td><?php echo $records[$i]['function'];?></td>
							<td class="text-left">
