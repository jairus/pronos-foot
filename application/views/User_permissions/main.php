				...
				<div class="form-group fg-line">
					...
					if(isset($filters)&&is_array($filters)){
						...
						<select class="selectpicker" multiple name="filters[]">
							<option value="user_group" <?php if(in_array("user_group", $filters)){ echo "selected"; } ?>>Permission</option>	<option value="class_name" <?php if(in_array("class_name", $filters)){ echo "selected"; } ?>>Class Name</option>	<option value="function" <?php if(in_array("function", $filters)){ echo "selected"; } ?>>Method</option>	
						</select>
						<?php
					}
					else{
						?>
						<select class="selectpicker" multiple name="filters[]">
							<option value="user_group">Permission</option>	<option value="class_name">Class Name</option>	<option value="function">Method</option>	
						</select>
						<?php
					}
					?>
...
?></th><th class="sortby" data-sortby="class_name" >Class Name <?php
...
?></th><th class="sortby" data-sortby="function" >Method <?php
	if($sortby=="function"){
		if($sort=="asc"){
			echo '&nbsp;<i class="zmdi zmdi-caret-up"></i>';
		}
