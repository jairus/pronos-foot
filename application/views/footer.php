<?php /*<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script>
...
<div class="w-section footer-section">
  <div class="w-container footer-container">
    <div class="w-row">
      <div class="w-col w-col-5 w-clearfix footer-column1"><img alt="Pronostics Foot Gratuit" width="80" src="assets/images/Logo.png" class="logo-image">
      ...
      <div class="w-col w-col-4">
        ...
        <a href="/my-account" data-ix="open-lightbox" class="w-inline-block w-clearfix facebook-link footer">
          <div class="w-clearfix facebook-button small footer"><img width="20" src="assets/images/facebook-logo.png" class="fecebook-logo footer">
