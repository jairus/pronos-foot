...
session_start();
class Admin_user_permissions extends CI_Controller {
	var $table;
	var $controller;
	public function __construct(){
		...
		$this->controller = "Admin_user_permissions";
	}
	...
	$error = "Please input Controller Class Name";
}
 else if ($_POST['function'] == ''){
	$error = "Please input Function";
}
		...
		if(!$error){
			...
			/*start fields*/
			$sql .= "`user_group` = '".db_escape($_POST['user_group'])."'";
$sql .= " ,`class_name` = '".db_escape($_POST['class_name'])."'";
$sql .= " ,`function` = '".db_escape($_POST['function'])."'";
